...
func (*Acknowledgement) Descriptor() ([]byte, []int) { return fileDescriptorTransit, []int{5} }
...
func (*Sub) Descriptor() ([]byte, []int) { return fileDescriptorTransit, []int{6} }
...
func (*Acked) Descriptor() ([]byte, []int) { return fileDescriptorTransit, []int{7} }
...
func (*ApplyCommands) Descriptor() ([]byte, []int) { return fileDescriptorTransit, []int{8} }
...
func (*Command) Descriptor() ([]byte, []int) { return fileDescriptorTransit, []int{9} }
...
func (*Server) Descriptor() ([]byte, []int) { return fileDescriptorTransit, []int{10} }
...
func (*Success) Descriptor() ([]byte, []int) { return fileDescriptorTransit, []int{11} }
...
func (*String) Descriptor() ([]byte, []int) { return fileDescriptorTransit, []int{12} }
...
func (*Strings) Descriptor() ([]byte, []int) { return fileDescriptorTransit, []int{13} }
...
func (*StringMap) Descriptor() ([]byte, []int) { return fileDescriptorTransit, []int{14} }
...
func (*Void) Descriptor() ([]byte, []int) { return fileDescriptorTransit, []int{15} }
...
var fileDescriptorTransit = []byte{
	...
	,
}
